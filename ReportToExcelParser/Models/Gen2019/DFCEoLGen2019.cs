...
namespace ReportToExcelParser.Models.Gen2019
{
    [XmlRoot(ElementName = "TestResultsCollection", Namespace = "urn:IEEE-1636.1:2011:01:TestResultsCollection")]
    public class TestResultsCollection : IEquatable<TestResultsCollection>
    {
        ...
        public bool Equals(TestResultsCollection other)
        {
